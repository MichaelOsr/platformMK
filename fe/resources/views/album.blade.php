    ...
    <div class="">
      <div class="flex items-center justify-between pt-6">
        ...
        <div class="relative lg:hidden">
          ...
          <input type="text" id="small-input" class="block px-9 py-2 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-blue-500 focus:border-blue-500" placeholder="Type here to search">
        </div>
      ...
      <div class="mt-4">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-3 gap-4 w-fit">
          ...
          @foreach ($dataAlbum as $album)
            <div>
              <img class="rounded-xl" src="https://i.ytimg.com/vi/fKtY_37r1VI/hqdefault.jpg?sqp=-oaymwEbCKgBEF5IVfKriqkDDggBFQAAiEIYAXABwAEG&rs=AOn4CLBfZaLFEtxONyLc_BWk_lDzojB9dw" alt="">
              <p class="font-bold">{{$album['nama_album']}}</p>
              {{-- <p class="text-sm text-gray-500">The Chainsmokers</p> --}}
              <div class="flex justify-between">
                <button class="block text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xs px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button" data-modal-toggle="delete-modal" onclick="deleteAlbums({{$album['id']}})">
                  Delete
                </button>
                <button class="block text-white bg-yellow-300 hover:bg-yellow-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xs px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button" data-modal-toggle="authentication-modal">
                  Edit
                </button>
              </div>
            </div>
          ...
          <div>
            <!-- Modal toggle -->
          <button class="block w-32 h-36 text-white bg-slate-400 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-3xl px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button" data-modal-toggle="authentication-modal">
            +
          </button>
          </div>
        </div>
            ...
            <div class="mt-8 flex items-center">
              <button class="w-9 hover:cursor-not-allowed" disabled>
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                  x="0px" y="0px" viewBox="0 0 496.158 496.158" style="enable-background:new 0 0 496.158 496.158;"
                  xml:space="preserve">
      ...
      <div class="mt-4">
        ...
        <div>
          <div class="mb-2 border shadow-md rounded-xl px-5 py-2 flex items-center w-[371px]">
            <img class="w-16 h-16 rounded-full" src="https://img.youtube.com/vi/6Pei_OGDNqc/hqdefault.jpg" alt="">
            <div class="w-1/2 ml-4">
              <h5 class="font-semibold">Album 1</h5>
            </div>
            <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2 focus:outline-none">Play</button>
          </div>
          ...
          <div class="border shadow-md rounded-xl px-5 py-2 flex items-center w-[371px]">
            ...
            <button type="button" class="py-2 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-full border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200">Play</button>
          </div>
      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div class="px-6 py-6 lg:px-8">
            ...
            <form class="space-y-6" action="/newAlbum" method="POST">
              @csrf
                <div>
                    <input type="text" name="namaAlbum" id="namaAlbum" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="My Album" required>
                </div>
                <button type="submit" class="block w-full h-36 text-white bg-slate-400 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-3xl px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Create</button>
            </form>
          </div>
      </div>
  </div>
